...
import CustomersTable, {
  hyper_customersTablecolumns,
} from "components/tables/Hyper_CustomerTable";
import { defaultBreadcrumbItems } from "data/commonData";
import { customers } from "../hyper_data";
...
const Customers = () => {
  const table = useAdvanceTable({
    data: customers,
    columns: hyper_customersTablecolumns,
    pageSize: 10,
    pagination: true,
    sortable: true,
    selection: true,
    ...
    <div>
      <div className="mb-9">
        <div className="page-title-box">
          <h2 className="mb-4 page-title">Customers</h2>
        </div>
