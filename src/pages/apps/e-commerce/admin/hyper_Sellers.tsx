...
import CustomersTable, {
  hyper_sellersTablecolumns,
} from "components/tables/Hyper_SellerTable";
import { defaultBreadcrumbItems } from "data/commonData";
import { sellers } from "../hyper_data";
...
const Sellers = () => {
  const table = useAdvanceTable({
    data: sellers,
    columns: hyper_sellersTablecolumns,
    pageSize: 10,
    pagination: true,
    sortable: true,
    selection: true,
    ...
    <div>
      <div className="mb-9">
        <div className="page-title-box">
          <h2 className="mb-4 page-title">Sellers</h2>
        </div>
