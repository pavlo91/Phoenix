...
import CustomersTable, {
  hyper_productsTablecolumns,
} from "components/tables/Hyper_Products";
import { defaultBreadcrumbItems } from "data/commonData";
import { products } from "../hyper_data";
...
const Products = () => {
  const table = useAdvanceTable({
    data: products,
    columns: hyper_productsTablecolumns,
    pageSize: 10,
    pagination: true,
    sortable: true,
    selection: true,
    ...
    <div>
      <div className="mb-9">
        <div className="page-title-box">
          <h2 className="mb-4 page-title">Products</h2>
        </div>
